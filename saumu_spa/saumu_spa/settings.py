"""
Django settings for saumu_spa project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-l7w%@0*3a#6wzbcwru^1d5jq2gyk0&-r72mhj^3l2on%_8&0yi')
...
WSGI_APPLICATION = 'saumu_spa.wsgi.application'
